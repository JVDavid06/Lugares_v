...
class LugarAdapter : RecyclerView.Adapter<LugarAdapter.LugarViewHolder>() {
    ...
    inner class LugarViewHolder(private val itemBinding: LugarFilaBinding) : RecyclerView.ViewHolder(itemBinding.root){
        ...
        fun bind(lugar : Lugar){
            ...
            Glide.with(itemBinding.root
                .context).load(lugar.rutaImagen).circleCrop().into(itemBinding.imagen)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LugarViewHolder {
        ...
        return LugarViewHolder(itemBinding) //devuelvo un card para "dibujar un lugar"
    }

    override fun onBindViewHolder(holder: LugarViewHolder, position: Int) {
        val lugar = listaLugares[position] //recupero el lugar a "dibujar"
        holder.bind(lugar) //se invoca la funcion definida en el inner calss
    }
    ...
    fun setData(lugares : List<Lugar>){
        ...
        notifyDataSetChanged() //activa el redibujo del recycle view
    }
